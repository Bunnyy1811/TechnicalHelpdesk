...
#MySQL config. Use Mysql 5.5.3 or above.
...
def init():
    ...
    try:
        cur.execute("""CREATE TABLE user (
                                        ...
                                        PRIMARY KEY (user_id))auto_increment=1001 DEFAULT CHARSET=utf8""")
    except:
        print("user table exists!")
    try:
        cur.execute("""CREATE TABLE feedback (phone bigint(10),message varchar(200)) DEFAULT CHARSET=utf8""")
    except:
    ...
    try:
        cur.execute("""CREATE TABLE ticket (ticket_id int AUTO_INCREMENT,
                                                        ...
                                                        FOREIGN KEY (user_id)
                                                        REFERENCES user(user_id))AUTO_INCREMENT=10001 DEFAULT CHARSET=utf8""")
    except:
    ...
    try:
        cur.execute("""CREATE TABLE inventory (inventory_id int AUTO_INCREMENT,
                                                            ...
                                                            REFERENCES ticket(ticket_id))AUTO_INCREMENT=20001 DEFAULT CHARSET=utf8""")
    except:
    ...
    try:
        cur.execute("""CREATE TABLE employee (employee_id int AUTO_INCREMENT,
                                                            ...
                                                            hash_password varchar(128),
                                                            picture varchar(200) DEFAULT '/static/images/no_dp.png',
                                                            PRIMARY KEY (employee_id))auto_increment=2001 DEFAULT CHARSET=utf8""")
    except:
    ...
    try:
        cur.execute("""CREATE TABLE assignment (ticket_id int UNIQUE,
                                                ...
                                                FOREIGN KEY(ticket_id)
                                                REFERENCES ticket(ticket_id)) DEFAULT CHARSET=utf8""")
    except:
    ...
    try:
        cur.execute("""CREATE TABLE employee_superior (employee_id int,
                                                        ...
                                                        REFERENCES employee(employee_id)) DEFAULT CHARSET=utf8""")
    except:
